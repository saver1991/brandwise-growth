...
import { Facebook, Instagram, Linkedin, Twitter, Youtube, Share2, Video, MessageSquare } from "lucide-react";
  ...
  return (
    <Card className={`transition-all ${isActive ? 'border-primary shadow-md' : 'hover:border-primary/50'}`}>
      ...
      <CardFooter className="border-t pt-4 flex justify-between">
        ...
        <Button variant="ghost" size="icon" onClick={() => navigate('/account/profile')}>
